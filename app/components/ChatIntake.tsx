        ...
        <div className="mx-auto flex w-full max-w-3xl flex-1 flex-col px-4 pb-16 pt-5 sm:px-8 md:px-14 md:pt-10">
          ...
          >
            ...
            <div className="flex flex-col gap-4 border-b border-border/60 p-6 md:px-8">
              ...
              <BriefActionBlock description="Six two-week solo AI track blueprints (finance, consulting, product, research, policy, clinical)—open in the app or download a standalone HTML copy for offline reading.">
                <div className="flex w-full flex-col gap-2 sm:flex-row sm:flex-wrap">
                  <Button asChild className="h-auto min-h-11 w-full flex-col gap-0.5 rounded-2xl py-2.5 cta-glow sm:w-fit sm:items-start sm:px-6">
                    <Link href="/ai-tracks">
                      <span className="text-base font-semibold">Six two-week AI tracks</span>
                      <span className="max-w-md text-left text-xs font-normal leading-snug text-primary-foreground/90">
                  ...
                  <Button asChild variant="outline" className="h-auto min-h-11 w-full flex-col gap-0.5 rounded-2xl border-border/70 bg-card py-2.5 sm:w-fit sm:items-start sm:px-6">
                    <a href="/api/ai-tracks-guide?download=1" rel="noreferrer">
                      <span className="text-base font-semibold">Download HTML guide</span>
                      <span className="max-w-md text-left text-xs font-normal leading-snug text-muted-foreground">
                        Standalone file — same content as the tracks page
                      </span>
                    </a>
                  </Button>
                </div>
