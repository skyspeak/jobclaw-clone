...
export const V3_SAMPLE_INPUTS: V3Inputs = {
...
export const V3_SAMPLE_ANALYSIS: V3Analysis = {
  job: {
  ...
  journeyStats: [
    { value: "3 gaps", label: "targeted, not a generic bootcamp", detail: "" },
  ...
  pod: {
    ...
    stats: [
      ...
      { value: "2.4×", label: "completion vs going solo" },
    ],
    mapPositions: [
  ...
  mentor: {
    ...
    quote:
      "When I screen entry level marketers, I am not looking for perfect. I am looking for someone who shipped one real thing and can tell me what the numbers did. That is exactly what this plan gets you to.",
    sessions: [
      {
        number: 1,
